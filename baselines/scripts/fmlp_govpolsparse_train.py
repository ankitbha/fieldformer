#!/usr/bin/env python3
"""Fourier-MLP sparse real pollution training with vector pollutant targets."""
...
def main(cfg: Config = CFG) -> None:
    train_coordinate_sparse(
        cfg,
        "fmlp",
        lambda c: FourierMLPPollution(width=c.width, depth=c.depth, kx=c.kx, ky=c.ky, kt=c.kt, out_dim=2),
    )
