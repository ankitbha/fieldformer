#!/usr/bin/env python3
"""
Senseiver (sparse pollution): train only from sensor observations.

This is a standalone adaptation of the core Senseiver encoder/decoder idea for
the pollution sparse datasets used in this repository. It does not use the original
...
class Config:
    ...
    grad_clip: float = 1.0
    patience: int = 12
    save: str = "/scratch/ab9738/fieldformer/baselines/checkpoints/senseiver_polsparse_best.pt"
...
def parse_args() -> Config:
    parser = argparse.ArgumentParser(description="Train Senseiver on sparse pollution sensor observations.")
    ...
    for epoch in range(1, cfg.epochs + 1):
        ...
        if rmse < best_rmse:
            ...
            ckpt = {
                ...
                "meta": {
                    "variant": "senseiver_pollution_sparse",
                    "obs_key": cfg.obs_key,
