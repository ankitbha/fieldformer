#!/usr/bin/env python3
"""Fourier-MLP sparse atmospheric training with normalized vector targets."""
...
def main(cfg: Config = CFG) -> None:
    train_coordinate_sparse(
        cfg,
        "fmlp",
        lambda c: FourierMLPPollution(width=c.width, depth=c.depth, kx=c.kx, ky=c.ky, kt=c.kt, out_dim=4),
    )
