#!/usr/bin/env python3
"""Fourier-MLP sparse heat training without FieldFormer local context."""
...
from baselines.models.fmlp import FourierMLP
...
def main(cfg: Config = CFG) -> None:
    train_coordinate_sparse(
        cfg,
        "fmlp",
        lambda c: FourierMLP(width=c.width, depth=c.depth, kx=c.kx, ky=c.ky, kt=c.kt, out_dim=1),
    )
