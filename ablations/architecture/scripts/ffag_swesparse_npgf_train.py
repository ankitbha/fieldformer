#!/usr/bin/env python3
"""FieldFormer sparse SWE gamma-field ablation: observation-only training."""
...
class Config:
    ...
    grad_clip: float = 0.5
    patience: int = 12
    save: str = "/scratch/ab9738/fieldformer/ablations/architecture/checkpoints/ffag_npgf_swesparse_best.pt"
