#!/usr/bin/env python3
"""FieldFormer sparse atmospheric gamma-field ablation: observation-only training."""
...
def _debug(msg: str) -> None:
    ...
    print(f"[debug:atm-npgf-entry +{elapsed:7.2f}s] {msg}", flush=True)
...
class Config:
    ...
    grad_clip: float = 0.5
    patience: int = 10
    save: str = "/scratch/ab9738/fieldformer/ablations/architecture/checkpoints/ffag_npgf_atmsparse_best.pt"
